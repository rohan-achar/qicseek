...
<head>
                <title>scientific and numerical computing @ the bren school of information and computer sciences</title>
...
<div id="content_title">Scientific and Numerical Computing</div>
...
</table><p>Scientific Computing refers to the application of computers to 
scientific problems, from astrophysics to zoology. </p>

			   <p>The mode of application can be system modeling, data analysis 
and mining, or visualization. </p>

			   <p>The focus can be on developing new computational techniques, 
such as parallel algorithms or new data mining ideas, or on the
			      novel application of existing techniques to new scientific 
problems. </p>

			   <p>A number of our faculty are focussed primarily on 
bio-informatics, so in addition to the links below, more information can
 be
			      found about bio-informatics at UCI by checking out
			      <a href="http://www.ics.uci.edu/&#126;biomed/">IBAM</a>
			      and
			      <a href="http://www.igb.uci.edu/">IGB</a>.</p>
