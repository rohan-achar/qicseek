...
<head>
<title>graduate course listing @ the bren school of information and computer sciences</title>


<meta content="Tue, 10 Dec 2013 07:39:11 -0320" name="date"/>
...
<script src="/bin/icssearchstyle/js/icssearchform.js" type="text/javascript"></script>
    ...
    </div><div class="bread" id="breadcrumbs"><!-- starting function breadcrumb_nav --><!-- done with function breadcrumb_nav, going to return [<A HREF="/">Bren school home</A> &gt; <a href="http://www.ics.uci.edu/grad/">Graduate</a> &gt; <a href="http://www.ics.uci.edu/grad/courses/">Courses</a>] --><A HREF="/">Bren school home</A> &gt; <a href="http://www.ics.uci.edu/grad/">Graduate</a> &gt; <a href="http://www.ics.uci.edu/grad/courses/">Courses</a></div>
<div id="content"><a id="startcontent" name="startcontent"></a> 
<div id="content_title">Graduate course listing </div>
<blockquote>
<div id="content_text"><p>
This is a <strong>tentative</strong> schedule of CompSci, Informatics, Networked Systems and Statistics courses that the Bren School is planning to offer.
</p>
<p>
...
<p>
<strong>NOTE:  The course listings shown here are neither guaranteed, nor considered &#8220;final&#8221;.  Department Chairs may provide updated information regarding course offerings or faculty assignments throughout the year.  Be sure to check this list regularly for new or revised information.</strong>   
</p>
<p>
...
<title>Courses @ the bren school of information and computer
sciences</title>

-->


<link type='text/css' rel='stylesheet' media='all' href='/bin/course_info/css/stylesheet.css' />
                    ...
                    <hr />
                    <form id='course_search' action='listing.php' method='get'>
                        <table border='0' width='430'>
                            <tbody>
                                <tr><td><strong>Year</strong></td></tr>
                                <tr><td>
                                        <select class='righttable' name='year' id='year'>
...
<option value='2008'>2008-2009</option>
                                ...
                                <tr><td>
                                        ...
                                        <select class='righttable' name='level' id='level'>
...
<option value='Upper-Division'>Upper-Division</option>
                                ...
                                <tr><td><strong>Department</strong></td></tr>
                                <tr><td>
                                        <select class='righttable' name='department' id='department'>
                                            <option value='ALL'>ALL</option>
...
<option value='US'>US</option>
                                ...
                                <tr><td><strong>Core Classes for</strong></td></tr>
                                <tr><td>
                                        <select class='righttable' name='program' id='program'>
                                            <option value='ALL'>ALL</option>
                                            <optgroup label='Undergraduate'>

<option value='0BMC'>Biomedical Computing</option>
<option value='0BIM'>Business Information Management</option>
<option value='0CGS'>Computer Game Science</option>
<option value='0COMPSCI'>Computer Science</option>
<option value='0CSE'>Computer Science and Engineering</option>
<option value='0IN4MATX'>Informatics</option>
<option value='0I&amp;C SCI'>Information and Computer Science</option>

                                            </optgroup>
                                            <optgroup label='Graduate'>

<option value='1COMPSCI'>Computer Science</option>
<option value='1IN4MATX'>Informatics</option>
<option value='1NetSys'>Networked Systems</option>
<option value='1STATS'>Statistics</option>

                                            </optgroup>
                                        </select>
                                    </td></tr>
                                <tr>
                                    <td><input class='righttable' type='submit' /></td>
                                </tr>
                            </tbody>
                        </table>
                        <hr />
                        <p><strong>Please select from the search criteria above.</strong></p>
                    </form>
