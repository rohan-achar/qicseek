...
<head>
                <title>security, privacy, and cryptography @ the bren school of information and computer sciences</title>
...
<div id="content_title">Security, Privacy, and Cryptography</div>
...
<TR bgcolor="#a5c8a4">
<strong>&raquo;</strong></font> <A HREF="/faculty/profiles/view_faculty.php?ucinetid=gtsudik">Gene  Tsudik</A><br></td></TR>
</table><p>  The development of secure communication protocols
    is a critical issue in today's age of pervasive communication. </p>
<p>Bren School  research
            in this area includes anonymity and authentication in network security, key
            agreement and digital signatures in cryptography, and security issues in electronic
            commerce. </p>
<p>Researchers also are designing high-performance algorithms and
            data structures for solving large-scale problems motivated from information
            assurance and security, the Internet, information visualization and geometric
            computing.</p>
<p>More information: <a href="http://sconce.ics.uci.edu/">http://sconce.ics.uci.edu/</a></p>
